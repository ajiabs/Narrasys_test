...
const data: templateData[] = [{path: `${pathToClientStyles}/_${nameSpace}.scss`, data: cssTemplate}, {path: `out/${nameSpace}.html`, data: htmlTemplate}];
...
data.forEach((blob:templateData) => {
