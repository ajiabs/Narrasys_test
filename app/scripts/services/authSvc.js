...
angular.module('com.inthetelling.story')
	...
	authentication paths:
		header + user data: resolve
		header + no user data: call show_user (shouldn't happen)
		...
		*/
		...
		// 			$http.defaults.headers.common.Authorization = 'Token token="' + validStoredData.token + '"';
		// 			svc.getCurrentUser().then(function () {
