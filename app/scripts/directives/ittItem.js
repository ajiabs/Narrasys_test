	...
	.directive('ittItem', function (modalMgr) {
		return {
			...
			link: function (scope, element, attrs) {
				...
				if (attrs.forceItemTemplate) { //TODO fix or remove this, it's a hack
					scope.item.origTemplateUrl = scope.item.templateUrl;
					scope.item.templateUrl = "templates/transmedia-" + scope.item.type + "-" + attrs.forceItemTemplate + ".html";
