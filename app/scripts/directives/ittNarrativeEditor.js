	...
	function ittNarrativeEditor() {
	    return {
			...
			template: [
				...
				'			<label for="nCustomer">Customer</label><span ng-if="nEditForm.customer.$invalid" class="error-red"> Required</span>',
				...
				'		</div>',
				'		<label id="nName">Name of Narrative</label><span ng-if="nEditForm.name.$invalid" class="error-red"> Required</span>',
				...
				'		<label for="nPath">Path</label><span ng-if="nEditForm.path.$invalid" class="error-red"> Required</span>',
				'		<input id="nPath" type="text" name="path" placeholder="link-to-narrative" ng-model="nEditor._narrative.path_slug.en" required/>',
				'		<label for="nSupportUrl">Support Url</label><span ng-if="nEditForm.supportUrl.$invalid" class="error-red"> Not a valid URL</span>',
