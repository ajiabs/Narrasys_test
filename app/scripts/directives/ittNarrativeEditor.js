  ...
  function ittNarrativeEditor() {
    return {
      ...
      template: [
        ...
        '   <div ng-if="!$ctrl._containerInfo"><itt-guest-accessible-url narrative="$ctrl._narrative" sub-domain="{{$ctrl.selectedCustomer.domains[0]}}" error="{{$ctrl.narrative.error}}"></itt-guest-accessible-url></div>',
