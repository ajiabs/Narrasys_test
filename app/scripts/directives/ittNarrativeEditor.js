	...
	function ittNarrativeEditor() {
	    return {
			...
			template: [
				...
				'		</div>',
				'		<label id="nName">Name of Narrative',
				'			<itt-validation-tip ng-if="nEditForm.name.$invalid" text="Name is a required"></itt-validation-tip>',
				'		</label>',
				...
				'		<label for="nPath">Path',
				'			<itt-validation-tip ng-if="nEditForm.path.$invalid"  text="Path is required"></itt-validation-tip>',
				'		</label>',
