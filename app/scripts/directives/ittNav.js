	...
	function ittNav() {
	    return {
			...
			template: [
				...
				'		<div class="nav__item">',
				'			<img ng-style="{width: $ctrl.inPlayer ? \'75%\' : \'100%\' }" src="images/Narrasys_Banner.svg"/>',
				'		</div>',
				...
				'					</div>',
				'					<a class="nav__button" ng-if="$ctrl.currentPath !== \'/projects\' && !$ctrl.inPlayer" href="/#/projects">My Projects</a>',
				'					<a class="nav__button" ng-if="$ctrl.currentPath !== \'/stories\' && !$ctrl.inPlayer" href="/#/stories">My Narratives</a>',
				'				</div>',
