...
PlayerController.$inject = ['config', '$scope', '$location', '$rootScope', '$routeParams', '$timeout', '$interval', 'appState', 'dataSvc', 'modelSvc', 'timelineSvc', 'analyticsSvc', 'errorSvc', 'authSvc', 'youTubePlayerManager', 'selectService'];
export default function PlayerController(config, $scope, $location, $rootScope, $routeParams, $timeout, $interval, appState, dataSvc, modelSvc, timelineSvc, analyticsSvc, errorSvc, authSvc, youTubePlayerManager, selectService) {
