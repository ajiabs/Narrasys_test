    ...
    if (($rootScope.isIPad || $rootScope.isIPod || $rootScope.isIPhone) && $rootScope.isFramed) {
      ...
      $scope.$watch(function () {
        ...
        if (newV > oldV) {
          ...
          angular.element('#CONTAINER').height($scope.windowHeight - 1).width($rootScope.windowWidth - 1);
        } else {
          ...
          angular.element('#CONTAINER').height($rootScope.windowHeight - 1).width($rootScope.windowWidth - 1);
        }
      });
