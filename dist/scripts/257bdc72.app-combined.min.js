...
return{restrict:"A",replace:!1,scope:{containerId:"=sxsContainerAssets"},templateUrl:"templates/producer/container-assets.html",compile:function(a){return c.compile(a,function(a){a.appState=g,e.containers[a.containerId]?(a.container=e.containers[a.containerId],a.container.assetsHaveLoaded||d.getContainerAssets(a.containerId)):d.getContainer(a.containerId).then(function(){a.container=e.containers[a.containerId],d.getContainerAssets(a.containerId)}),a.assets=e.assets,a.uploadStatus=[],a.up=function(){a.showParent=!0},a.toggleImages=function(){a.onlyImages=!a.onlyImages},a.toggleGrid=function(){a.gridView=!a.gridView},a.assetClick=function(a){b.$emit("UserSelectedAsset",a)},a.uploadAsset=function(b){var c=b.files;a.uploadStatus[0]={bytesSent:0,bytesTotal:1},a.uploads=f.uploadContainerFiles(a.containerId,c),a.uploads[0].then(function(c){e.cache("asset",c.file),b.value="",delete a.uploads},function(){},function(b){a.uploadStatus[0]=b})}})}}}]),angular.module("com.inthetelling.story").directive("ittAssetUploader",ittAssetUploader),ittAssetUploader.$inject=["$timeout","awsSvc","appState","modelSvc"];