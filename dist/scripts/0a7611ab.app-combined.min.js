...
angular.module('com.inthetelling.story').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/episode/career-playbook.html',
    "<div class=\"episode professional career-playbook\" ng-class=\"episode.styleCss\"><span ng-include=\"'templates/episode/components/reviewmode.html'\"></span> <span ng-include=\"'templates/episode/components/watchmode.html'\"></span> <span ng-repeat=\"scene in episode.scenes | isCurrent\" ng-include=\"'templates/episode/components/discovermode.html'\"></span> <span ng-include=\"'templates/episode/components/video.html'\"></span> <span ng-include=\"'templates/episode/components/windowfg.html'\"></span><div ng-if=\"appState.viewMode != 'watch'\" class=\"professional__branding\"><div class=\"branding--content\"><nys-copyright class=\"professional__copyright\"></nys-copyright><img class=\"professional__logo\" src=\"images/customer/CPB_Logo-01-2.svg\"></div></div></div>"
  );
  ...
  $templateCache.put('templates/episode/components/reviewmode.html',
    "<div ng-if=\"appState.viewMode == 'review'\" class=\"searchMode\"><div itt-magnet=\"\" id=\"searchVideoMagnet\" class=\"videoMagnet\"><img src=\"images/aspectratiopreserver-16x9.gif\"></div><div itt-search-panel=\"\"></div></div>"
  );
  ...
  $templateCache.put('templates/episode/narrasys-pro.html',
    "<div class=\"episode professional narrasys\" ng-class=\"episode.styleCss\"><span ng-include=\"'templates/episode/components/reviewmode.html'\"></span> <span ng-include=\"'templates/episode/components/watchmode.html'\"></span> <span ng-repeat=\"scene in episode.scenes | isCurrent\" ng-include=\"'templates/episode/components/discovermode.html'\"></span> <span ng-include=\"'templates/episode/components/video.html'\"></span> <span ng-include=\"'templates/episode/components/windowfg.html'\"></span><div ng-if=\"appState.viewMode != 'watch'\" class=\"professional__branding\"><div class=\"branding--content\"><nys-copyright class=\"professional__copyright\"></nys-copyright><img class=\"professional__logo\" src=\"images/customer/Narrasys_brand_logo.svg\"></div></div></div>"
  );
  ...
  $templateCache.put('templates/iframe.html',
    "<div class=\"iframeContainer\"><itt-loading ng-if=\"$ctrl.isLoading\"></itt-loading><iframe ng-if=\"!ctrl.isLoading\" ng-src=\"{{$ctrl.src}}\" ng-attr-scrolling=\"{{$ctrl.iOSScroll}}\" ng-style=\"$ctrl.styles\" ng-attr-sandbox=\"{{$ctrl.sandbox}}\"></iframe></div>"
  );
  ...
  $templateCache.put('templates/producer/item/producer-chapter.html',
    ""
  );
  ...
  $templateCache.put('templates/scene/centerVV-mondrial.backup.html',
  ...
  $templateCache.put('templates/scene/mirrored-twocol.html',
    "<div class=\"scene cornerV\" ng-class=\"scene.styleCss + ' '+ scene.state\"><div class=\"col\"><div itt-magnet=\"\" class=\"videoMagnet\"><img src=\"images/aspectratiopreserver-16x9.gif\"></div><div class=\"pane mainPane\"><div class=\"fill bgLayer\"><div class=\"item animate\" ng-repeat=\"item in altBgItems | isCurrent\" ng-class=\"item.styleCss + ' ' + item.state\" itt-item=\"item\"></div></div><div class=\"content contentLayer stretchToViewport\" ng-class=\"{singleitem: altContentItems.length==1, isNarrow: isNarrow, isEmpty: altContentItems.length == 0}\" itt-width-watch=\"\"><div class=\"item animate\" ng-repeat=\"item in altItems = (altContentItems | isCurrent)\" ng-class=\"item.styleCss + ' ' + item.state\" itt-item=\"item\"></div><div class=\"clear\"></div></div><div class=\"fill fgLayer overlay\"><div class=\"item animate\" ng-repeat=\"item in altFgItems | isCurrent\" ng-class=\"item.styleCss + ' ' + item.state\" itt-item=\"item\"></div></div></div></div><div class=\"col\"><div class=\"pane altPane stretchToViewport\"><div class=\"fill bgLayer\"><div class=\"item animate\" ng-repeat=\"item in mainBgItems | isCurrent\" ng-class=\"item.styleCss + ' ' + item.state\" itt-item=\"item\"></div></div><div class=\"content contentLayer stretchToViewport\" ng-class=\"{\n" +
    "\t\t\t\tsingleitem: showCurrent\n" +
    "\t\t\t\t\t? (mainContentItems | isCurrent).length == 1\n" +
    "\t\t\t\t\t: (mainContentItems).length == 1,\n" +
    "\t\t\t\tallowHighlights: !showCurrent,\n" +
...
angular.module('com.inthetelling.story')
	.factory('modelSvc', ["$interval", "$filter", "$location", "ittUtils", "config", "appState", "youtubeSvc", "playbackService", "urlService", function ($interval, $filter, $location, ittUtils, config, appState, youtubeSvc, playbackService, urlService) {
...
angular.module('com.inthetelling.story')
	.factory('timelineSvc', ["$window", "$timeout", "$interval", "$rootScope", "$filter", "config", "modelSvc", "appState", "analyticsSvc", "playbackService", "PLAYERSTATES", "ittUtils", function ($window, $timeout, $interval, $rootScope, $filter, config, modelSvc, appState, analyticsSvc, playbackService, PLAYERSTATES, ittUtils) {
...
angular.module('com.inthetelling.story')
	.factory('analyticsSvc', ["$q", "$http", "$routeParams", "$interval", "config", "appState", "playbackService", function ($q, $http, $routeParams, $interval, config, appState, playbackService) {
...
(function () {
	...
	youTubePlayerManager.$inject = ["$location", "YoutubePlayerApi", "errorSvc", "PLAYERSTATES", "youtubeSvc"];
...
(function() {
	...
	html5PlayerManager.$inject = ["$interval", "PLAYERSTATES", "ittUtils"];
})();
...
(function() {
	...
	playbackService.$inject = ["$interval", "youTubePlayerManager", "html5PlayerManager", "ittUtils", "urlService", "PLAYERSTATES_WORD", "PLAYERSTATES"];
...
(function() {
	...
	urlService.$inject = ["youtubeSvc", "html5UrlService"];
...
angular.module('com.inthetelling.story')
	.controller('TimelineController', ["$scope", "timelineSvc", "modelSvc", "appState", "playbackService", function ($scope, timelineSvc, modelSvc, appState, playbackService) {
...
angular.module('com.inthetelling.story')
	.controller('PlayerController', ["config", "$scope", "$location", "$rootScope", "$routeParams", "$timeout", "$interval", "appState", "dataSvc", "modelSvc", "timelineSvc", "analyticsSvc", "errorSvc", "authSvc", "selectService", "playbackService", function (config, $scope, $location, $rootScope, $routeParams, $timeout, $interval, appState, dataSvc, modelSvc, timelineSvc, analyticsSvc, errorSvc, authSvc, selectService, playbackService) {
...
angular.module('com.inthetelling.story')
	.controller('SceneController', ["$scope", "$filter", "ittUtils", function ($scope, $filter, ittUtils) {
...
angular.module('com.inthetelling.story')
	.controller('EditController', ["$q", "$scope", "$rootScope", "$timeout", "$window", "selectService", "appState", "dataSvc", "modelSvc", "timelineSvc", "authSvc", "MIMES", "playbackService", function ($q, $scope, $rootScope, $timeout, $window, selectService, appState, dataSvc, modelSvc, timelineSvc, authSvc, MIMES, playbackService) {
...
angular.module('com.inthetelling.story')
	.directive('ittTimeline', ["$rootScope", "$timeout", "appState", "timelineSvc", "modelSvc", "playbackService", function ($rootScope, $timeout, appState, timelineSvc, modelSvc, playbackService) {
		return {
			restrict: 'A',
			replace: true,
			scope: true,
...
(function () {
	...
	ittIframeCtrl.$inject = ["$scope", "ittUtils", "appState"];
...
angular.module('com.inthetelling.story')
	.directive('ittItem', ["$http", "$timeout", "$interval", "config", "authSvc", "appState", "analyticsSvc", "timelineSvc", "modelSvc", "selectService", "playbackService", "urlService", function ($http, $timeout, $interval, config, authSvc, appState, analyticsSvc, timelineSvc, modelSvc, selectService, playbackService, urlService) {
		return {
			restrict: 'A',
			replace: false,
			scope: {
...
angular.module('com.inthetelling.story')
	.directive('ittEpisodeEditor', ["$rootScope", "appState", "errorSvc", "modelSvc", "dataSvc", "awsSvc", "youtubeSvc", "authSvc", "selectService", function ($rootScope, appState, errorSvc, modelSvc, dataSvc, awsSvc, youtubeSvc, authSvc, selectService) {
		return {
			restrict: 'A',
			replace: true,
			scope: {
 ...
 */
angular.module('com.inthetelling.story')
	.directive('ittItemEditor', ["$rootScope", "$timeout", "errorSvc", "appState", "modelSvc", "timelineSvc", "awsSvc", "dataSvc", "youtubeSvc", "selectService", function ($rootScope, $timeout, errorSvc, appState, modelSvc, timelineSvc, awsSvc, dataSvc, youtubeSvc, selectService) {
		return {
			restrict: 'A',
			replace: true,
			scope: {
...
angular.module('com.inthetelling.story')
	.directive('ittMagnet', ["$rootScope", "appState", "playbackService", function ($rootScope, appState, playbackService) {
		return {
			restrict: 'A',
			replace: true,
			scope: true,
...
angular.module('com.inthetelling.story')
	.directive('ittContainer', ["$timeout", "$location", "$route", "appState", "modelSvc", "recursionHelper", "dataSvc", "ittUtils", function ($timeout, $location, $route, appState, modelSvc, recursionHelper, dataSvc, ittUtils) {
		return {
			restrict: 'A',
			replace: false,
			scope: {
...
(function () {
	...
	ittValidItemUrl.$inject = ["$q", "youtubeSvc", "ittUtils", "dataSvc"];
...
angular.module('com.inthetelling.story')
	.directive('sxsAddContent', ["appState", "playbackService", function (appState, playbackService) {
		return {
			restrict: 'A',
			replace: true,
			scope: {},
...
angular.module('com.inthetelling.story')
	.directive('sxsInputTime', ["appState", "$rootScope", "$timeout", "modelSvc", "timelineSvc", "playbackService", function (appState, $rootScope, $timeout, modelSvc, timelineSvc, playbackService) {
		return {
			// require: 'ngModel',
			scope: {
				item: '=sxsInputTime'
...
angular.module('com.inthetelling.story')
	.controller("ContainerAssetsTestController", ["$scope", "$routeParams", "authSvc", function ($scope, $routeParams, authSvc) {
		$scope.logout = authSvc.logout;
		$scope.containerId = $routeParams.containerId;
	}])
	/* WARN I badly misnamed this; it's used in  producer.  TODO eliminate the sxs prefix, it never made sense anyway */
	.directive('sxsContainerAssets', ["$routeParams", "$rootScope", "recursionHelper", "dataSvc", "modelSvc", "awsSvc", "appState", "MIMES", "authSvc", function ($routeParams, $rootScope, recursionHelper, dataSvc, modelSvc, awsSvc, appState, MIMES, authSvc) {
		return {
			restrict: 'A',
			replace: false,
			scope: {
